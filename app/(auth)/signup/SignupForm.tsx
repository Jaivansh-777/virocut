...
export default function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({ type: "success", message: "Account created! Welcome to RePurpose." });
    ...
    >
      <Card className="w-full max-w-md p-6 sm:p-8 bg-slate-900/50 backdrop-blur-xl border-white/10">
        <div className="text-center mb-6 sm:mb-7">
          ...
          <h1 className="text-xl font-bold mb-1.5 text-white">Join ViroCut</h1>
          <p className="text-sm text-slate-400">Create viral clips in seconds</p>
        </div>
