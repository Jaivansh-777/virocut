    ...
    <div className="space-y-6 sm:space-y-8 py-6 sm:py-8">
      ...
      >
        ...
        <Link href="/upload" className="w-full sm:w-auto">
          <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 w-full sm:w-auto">
          ...
          >
            <Card className="p-4 sm:p-5 bg-slate-900/50 backdrop-blur-xl border-white/10 active:bg-slate-800/50 transition-colors">
              <div className="flex items-start justify-between">
                ...
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-md flex-shrink-0">
                  <stat.icon className="w-4 h-4 shrink-0 text-white" />
                </div>
              </div>
        ...
        <Card className="p-8 sm:p-10 bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-indigo-500/10 border-indigo-500/20">
          <div className="text-center">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-indigo-500/20">
              <Video className="w-7 h-7 shrink-0 text-white" />
            </div>
              ...
              <Card className="overflow-hidden bg-slate-900/50 backdrop-blur-xl border-white/10 active:bg-slate-800/50 transition-colors">
                <div className="aspect-video bg-slate-800/50 relative overflow-hidden">
                  ...
                  <div className="absolute top-2.5 right-2.5">
                    ...
                    >
                      {project.status === "processing" && <Zap className="w-3 h-3 shrink-0 animate-pulse" />}
                ...
                <div className="p-3.5">
                  ...
                  <div className="flex items-center gap-3 text-xs text-slate-400">
                    ...
                    <span className="flex items-center gap-1">
                      <Captions className="w-3 h-3 shrink-0" />
